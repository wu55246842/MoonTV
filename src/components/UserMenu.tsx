      ...
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xl max-h-[90vh] bg-white dark:bg-gray-900 rounded-xl shadow-xl z-[1001] p-6 overflow-y-auto'>
        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex items-center gap-3'>
              {/* 状态徽章 */}
              <div className={`flex items-center gap-1.5 px-3 py-2 rounded-full text-xs font-medium shrink-0 ${tvboxEnabled
                  ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400'
                  : 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400'
                }`}>
                <div className={`w-2 h-2 rounded-full ${tvboxEnabled ? 'bg-green-500 animate-pulse' : 'bg-gray-400'
                  }`} />
